-- FIXED_SAFE_RENAME_SCHOOLS_TO_STATES.sql
-- This script safely renames schools to states while handling RLS policy dependencies
...
-- ===========================================
-- 3. UPDATE FOREIGN KEY REFERENCES SAFELY
-- ===========================================

-- TEACHERS TABLE: Update school_id to state_id FIRST
...
-- CLASSES TABLE: Add state_id column
...
-- Add new foreign key constraint for state_id
...
-- Update RLS policies to use state_id instead of school_id
-- First, let's see what policies exist
SELECT 'Current RLS policies on classes table:' as info;
...
-- Now we can safely drop the old school_id column
