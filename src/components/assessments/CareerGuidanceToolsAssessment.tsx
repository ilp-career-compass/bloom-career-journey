...
import { HelpCircle, CheckCircle, ArrowLeft, Globe, Search, ArrowRight
} from 'lucide-react';
      ...
      try {
        ...
        const { data: inserted, error: insertError } = await supabase
          ...
          .upsert({
            ...
            assessment_title: 'Career Guidance Tools',
            responses: {},
            completed_at: null,
    ...
    <div className="min-h-screen bg-gradient-to-br from-purple-50 via-white to-indigo-50 py-8" lang={lang} dir="auto">
      ...
      <div className="sticky top-0 z-40 bg-white border-b border-gray-200 shadow-sm md:hidden">
        <div className="flex items-center justify-between px-2 py-2 sm:px-4 sm:py-3">
          ...
          <h1 className="text-sm sm:text-base font-bold text-gray-800 flex-1 text-center break-words px-1 leading-tight">
            {lang === 'kn' ? (
              'ವೃತ್ತಿ ಮಾರ್ಗದರ್ಶನ ಪರಿಕರಗಳು'
            ) : lang === 'ta' ? (
              'தொழில் வழிகாட்டுதல் கருவிகள்'
            ) : lang === 'hi' ? (
              'कैरियर मार्गदर्शन उपकरण'
            ) : (
        ...
        <div className="container mx-auto flex items-center justify-between">
          ...
          <div className="text-center flex-1 flex flex-col items-center">
            <h1 className="text-base md:text-lg lg:text-xl font-bold text-indigo-800 leading-tight break-words px-1">
              🧭 {t('assessment_career_guidance') || 'Career Guidance Tools'}
            </h1>
      ...
      <div className="container mx-auto px-4">
        ...
        <div className="text-center mb-8">
          <h1 className="hidden md:block text-3xl font-bold text-purple-800 mb-4">🌐 {dbTitle || '8. Exploring Career Guidance Tools'}</h1>
