...
type AssessmentType = 'inspiration' | 'dreams' | 'state_learning' | 'role_models' | 'hobbies';
        ...
        <Card className="border shadow-sm">
          ...
          <CardContent>
            <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-3">
              {(['inspiration','dreams','state_learning','role_models','hobbies'] as AssessmentType[]).map(t => {
