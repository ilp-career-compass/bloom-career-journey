...
-- This script will analyze the current database structure and identify all dependencies
...
SELECT t.id, t.user_id, t.school_id, t.class_id, s.name as school_name
